...
inicio:- %Inicio de nuestro programa, creando el objeto de dialogo con la variable D
 ...
 new(D,dialog('SISTEMA EXPERTO UNAL',size(800,2350))),% inicio de nuestra interfaz principal


new(Label1,label(text,'..........................UNIVERSIDAD NACIONAL.......................')),% muestra texto dentro de los label
...
new(Label4,label(text,'                          Bienvenido al sistema experto UNAL')),
	send(Label4,colour,blue),
new(Label5,label(text,'Sistema de orientaci�n sobre las carreras que se imparten en la UNAL.')),
...
principal:-
	new(D2, dialog('SISTEMA EXPERTO UNAL',size(500,400))), %inicio de nuestra interfaz emergente
...
main1:-
	new(D3, dialog('SISTEMA EXPERTO UNAL',size(500,400))),
	...
	new(@texto,label(text,'                                      Guia basica para saber el guncionamiento de la pagina de prolog:')),
	 ...
	 new(@texto2,label(text,'Universidad nacional, adem�s de dar una orientaci�n sobre las carreras que se imparten en la')),
...
main2:-
new(D4, dialog('SISTEMA EXPERTO UNAL',size(500,400))),
